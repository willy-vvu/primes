...
Over the past few years, there has been a tremendous increase in the popularity of MOOCS, also known as massive open online courses, leading to a rise in their importance for educating students around the world as well as a tremendous amount of funding for these courses. Both the MOOCS systems coursera and edX; 370,000 in edX and 1.7 million in coursera, these enormous numbers show that MOOCS are extremely important to the education system. The amount of money poured into them also reveals this, with 60 million dollars put into edX. The huge number of students in these courses also lead to a very high student to professor ratio, 150,000:1 in some courses.

The increase in the number of students assigned to a single proffesor in such courses leads to many problems, not the least of which is the inability of a single professor to grade all the assignments they give out, which can sometimes number in the thousands. To solve this problem, there are two man solutions in use today; automated grading and peer grading. Automated grading relys on having machines grade papers; this is fast, but it may not always be fair to students because machines can only handle a certain number of answers, limiting the types of questions that may be asked. Peer grading, however, has no limit on grading, but a system utilizing it could be "hacked" by the students. In practice, though, both of these systems are unpolished and rather inefficient.

The problem that we have located is important to solve, because without it the MOOCS cannot provide efficient feedback for their students. Without his feedback, students are unable to effectively evaluate what they know and do not know, limiting their learning abilities. As such, it is imperitive that an efficient system is created to allow these students to learn and grow efficiently. This is our goal.

With the importance of such a problem, there have been many attempts at solving it; however all these attempts lack one thing, which we hope to introduce into our solution. In all previous attempts and current designs for grading the papers of students, there is something lacking; a rigourous mathematical proof and analysis of the system. With our system, we hope to introduce a set of criteria that the system must pass, and then analyze it mathematically to prove the efficiency of our solutions. Introducing this to the problem will help to create a concrete system of grading that will consistently and universally produce positive results, both in terms of efficiency, and fairness for the students.

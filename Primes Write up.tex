...
Computed from the above, the objective function of this mechanism is 4 --- a very low value. A value of 4 is equivalent to if we convinced every student to accurately grade 4 papers.
